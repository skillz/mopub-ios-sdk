...
@interface MPProgressOverlayViewSKZ ()
...
@implementation MPProgressOverlayViewSKZ
...
- (id)initWithFrame:(CGRect)frame
{
    ...
    if (self) {
        ...
        UIImage *image = [UIImage imageFromResource:@"MPCloseButtonX_SKZ.png"];
...
- (void)drawRect:(CGRect)rect
{
    ...
    CGFunctionRef shadingFunction = CGFunctionCreate((__bridge void *)(self), 1, (const CGFloat *)input_value_range, 4,
