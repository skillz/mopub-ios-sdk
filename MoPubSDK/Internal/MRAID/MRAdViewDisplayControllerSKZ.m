...
@implementation MRAdViewDisplayControllerSKZ
     ...
     jsEventEmitter:(MRJavaScriptEventEmitterSKZ *)jsEventEmitter
{
    ...
    if (self) {
        ...
        _dimmingView = [[MRDimmingViewSKZ alloc] initWithFrame:MPKeyWindow().frame];
...
- (void)initializeJavascriptStateWithViewProperties:(NSArray *)viewProperties
{
    ...
    properties = [properties arrayByAddingObjectsFromArray:[NSArray arrayWithObjects:
            [MRScreenSizePropertySKZ propertyWithSize:MPApplicationFrame().size],
            [MRStatePropertySKZ propertyWithState:_currentState],
            nil]];
...
- (void)expandAnimationDidStop {
    ...
    [self.jsEventEmitter fireChangeEventForProperty:[MRStatePropertySKZ propertyWithState:_currentState]];
