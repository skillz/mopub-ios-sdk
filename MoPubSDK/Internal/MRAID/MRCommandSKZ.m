...
@implementation MRCloseCommandSKZ

+ (void)load {
    [MRCommandSKZ registerCommand:self];
}
...
@implementation MRExpandCommandSKZ
...
@implementation MRUseCustomCloseCommandSKZ
...
@implementation MROpenCommandSKZ
