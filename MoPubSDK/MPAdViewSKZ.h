 ...
 * property to `nil`.
 */
@property (nonatomic, assign) id<MPAdViewDelegateSKZ> delegate;
...
@protocol MPAdViewDelegateSKZ <NSObject>
 ...
 */
- (void)adViewDidLoadAd:(MPAdViewSKZ *)view;
 ...
 * @param view The ad view sending the message.
 */
- (void)adViewDidFailToLoadAd:(MPAdViewSKZ *)view;
 ...
 */
- (void)willPresentModalViewForAd:(MPAdViewSKZ *)view;
 ...
 */
- (void)didDismissModalViewForAd:(MPAdViewSKZ *)view;
 ...
 * @param view The ad view sending the message.
 */
- (void)willLeaveApplicationFromAd:(MPAdViewSKZ *)view;
