...
@interface MPMockViewabilityTracker : NSObject <MPViewabilityTracker>

#pragma mark - Testing

@property (nonatomic, readonly) BOOL didTrackAdLoad;
@property (nonatomic, readonly) BOOL didTrackImpression;
@property (nonatomic, readonly) NSArray<UIView<MPViewabilityObstruction> *> *registeredFriendlyObstructions;
